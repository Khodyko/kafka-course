package io.club.javaholic;


import io.club.javaholic.processor.BotCountStreamBuilder;
import io.club.javaholic.processor.EventCountTimeseriesBuilder;
import io.club.javaholic.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreamsApp {
    ...
    private static Logger log = LoggerFactory.getLogger(WikimediaStreamsApp.class.getSimpleName());
